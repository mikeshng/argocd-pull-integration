...
# OCM bundle version for clusteradm init/join (see: https://github.com/open-cluster-management-io/OCM/releases)
OCM_BUNDLE_VERSION ?= v1.1.1
...
test-e2e: manifests generate fmt vet ## Run e2e deployment tests only (checks pods running and logs)
	...
	OCM_BUNDLE_VERSION=$(OCM_BUNDLE_VERSION) ./test/e2e/scripts/setup_ocm_env.sh
	@echo ""
